...
namespace {
  ...
  public:
    ...
    //  chunksize.
    explicit WaveformGenerator(unsigned int maxsize, unsigned int chunksize) :
      maxsize_{maxsize}, chunksize_{chunksize}
    {
    }
  ...
  int main()
  {
    ...
    g.with<WaveformGenerator>(
       &WaveformGenerator::predicate, &WaveformGenerator::unfold, concurrency::unlimited)
